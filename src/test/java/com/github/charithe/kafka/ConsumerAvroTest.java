...
public class ConsumerAvroTest {
    ...
    @Test
    public void testConsumerWithAvro() throws Exception {
        ...
        try (KafkaProducer<String, GenericRecord> producer =
                     broker.createProducer(new StringSerializer(), new AvroToBytesSerializer(), null)) {
            Future<RecordMetadata> result =
                    producer.send(new ProducerRecord(TEST_TOPIC, "key1", customer));
